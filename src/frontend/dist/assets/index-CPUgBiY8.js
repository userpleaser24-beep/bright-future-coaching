const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-D3NRwcOo.js","assets/badge-axtPznJk.js","assets/arrow-right-ghziYBFf.js","assets/award-BGvRuOVH.js","assets/chevron-right-LyLfF4Ab.js","assets/users-BgR1S1fV.js","assets/circle-check-big-DPotu2js.js","assets/Courses-C68n1Ejt.js","assets/CourseNeet-BQVFmRBj.js","assets/CourseDetail-DxFr2rFf.js","assets/clock-DZt1W0_r.js","assets/target-Cpc2OVhN.js","assets/CourseIitJee-BaVRpqve.js","assets/CourseCee-gwvILpNE.js","assets/CourseBoard-D1jyQwfu.js","assets/About-DYwqG236.js","assets/Contact-DQWv93yV.js"])))=>i.map(i=>d[i]);
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-primary text-primary-foreground", "data-ocid": "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 bg-accent rounded-xl flex items-center justify-center shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-6 h-6 text-accent-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-primary-foreground text-sm tracking-wide uppercase", children: "Bright Future" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/70 tracking-widest uppercase", children: "Coaching Centre" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-primary-foreground/80 leading-relaxed mb-5", children: "Igniting student potential through expert guidance, focused curriculum, and personalized mentorship for competitive and board examinations." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-accent flex-shrink-0" }),
                "+91 6003 549 471"
              ]
            }
          ),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-accent text-sm tracking-widest uppercase mb-5", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-3", children: quickLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: link.href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-accent text-sm tracking-widest uppercase mb-5", children: "Our Courses" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-3", children: courseLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: link.href,
            className: "font-body text-sm text-primary-foreground/80 hover:text-accent transition-smooth hover:translate-x-1 inline-block",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-accent text-sm tracking-widest uppercase mb-5", children: "Contact Info" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-accent flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("address", { className: "not-italic font-body text-sm text-primary-foreground/80 leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-accent flex-shrink-0" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-primary-foreground/60 text-center sm:text-left", children: [
        "© ",
        year,
        " Bright Future Coaching Centre. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-primary-foreground/50 text-center sm:text-right", children: [
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 lg:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 lg:w-12 lg:h-12 bg-primary rounded-xl flex items-center justify-center shadow-card group-hover:shadow-elevated transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-6 h-6 text-primary-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-primary text-sm lg:text-base tracking-wide uppercase leading-none", children: "Bright Future" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs text-muted-foreground tracking-widest uppercase", children: "Coaching Centre" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              children: navLinks.map(
                (link) => link.children ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      className: `flex items-center gap-1 px-4 py-2 rounded-lg font-display font-medium text-sm transition-smooth ${isActive(link.href) ? "text-primary bg-primary/8" : "text-foreground hover:text-primary hover:bg-primary/5"}`,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `absolute top-full left-0 mt-1 w-56 bg-card border border-border rounded-xl shadow-elevated py-2 transition-smooth origin-top ${coursesOpen ? "opacity-100 scale-100 pointer-events-auto" : "opacity-0 scale-95 pointer-events-none"}`,
                      onMouseEnter: () => setCoursesOpen(true),
                      onMouseLeave: () => setCoursesOpen(false),
                ...
                ] }, link.label) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: link.href,
                    className: `px-4 py-2 rounded-lg font-display font-medium text-sm transition-smooth ${isActive(link.href) ? "text-primary bg-primary/8" : "text-foreground hover:text-primary hover:bg-primary/5"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-accent text-accent-foreground hover:bg-accent/90 font-display font-semibold text-sm px-5 rounded-lg shadow-card hover:shadow-elevated transition-smooth", children: "Enroll Now" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1", children: [
              navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: link.href,
                    className: `block px-4 py-3 rounded-lg font-display font-medium text-sm transition-smooth ${isActive(link.href) ? "text-primary bg-primary/8" : "text-foreground hover:text-primary hover:bg-primary/5"}`,
                    "data-ocid": `header.mobile_menu.${link.label.toLowerCase()}`,
                    children: link.label
                  }
                ),
                link.children && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-4 mt-1 flex flex-col gap-0.5", children: link.children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: child.href,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-full bg-accent text-accent-foreground hover:bg-accent/90 font-display font-semibold", children: "Enroll Now" })
                }
              )
            ] })
          }
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-D3NRwcOo.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
const CoursesPage = reactExports.lazy(() => __vitePreload(() => import("./Courses-C68n1Ejt.js"), true ? __vite__mapDeps([7,1,4,2]) : void 0));
const NeetPage = reactExports.lazy(() => __vitePreload(() => import("./CourseNeet-BQVFmRBj.js"), true ? __vite__mapDeps([8,9,1,10,5,11,6,2]) : void 0));
const IitJeePage = reactExports.lazy(() => __vitePreload(() => import("./CourseIitJee-BaVRpqve.js"), true ? __vite__mapDeps([12,9,1,10,5,11,6,2]) : void 0));
const CeePage = reactExports.lazy(() => __vitePreload(() => import("./CourseCee-gwvILpNE.js"), true ? __vite__mapDeps([13,9,1,10,5,11,6,2]) : void 0));
const BoardPage = reactExports.lazy(() => __vitePreload(() => import("./CourseBoard-D1jyQwfu.js"), true ? __vite__mapDeps([14,9,1,10,5,11,6,2]) : void 0));
const AboutPage = reactExports.lazy(() => __vitePreload(() => import("./About-DYwqG236.js"), true ? __vite__mapDeps([15,1,5,3,11,2]) : void 0));
const ContactPage = reactExports.lazy(() => __vitePreload(() => import("./Contact-DQWv93yV.js"), true ? __vite__mapDeps([16,1,10,6]) : void 0));
const PageLoader = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-[60vh]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 border-4 border-primary border-t-accent rounded-full animate-spin" }) });
const wrap = (Component2) => () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component2, {}) });
